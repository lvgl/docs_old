...
Çizgi nesnesinin boyutunu onun uç noktalarına  göre boyutunu otomatik ayarlamak  mümkündür.
...
Çizgi  `lv_line_set_style(led, LV_LINE_STYLE_MAIN, &style)`ile ayarlanabilen bir biçim kullanır ve onun tüm `style.line` 
