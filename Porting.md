...
You can configure the driver for different operation modes. To learn more about the drawing modes visit [Drawing and rendering](https://github.com/littlevgl/lvgl/wiki/Basics#Drawing-and-rendering).
