...
The `lv_list_set_style(list, LV_LIST_STYLE_..., &style)` function sets the style of a list. For details explanation of _BG_, _SCRL_ and _SB_ see [Page](https://github.com/littlevgl/lvgl/wiki/Page)
...
## Example
![List image](https://raw.githubusercontent.com/wiki/littlevgl/lvgl/img/list-lv_list.png)
```c
